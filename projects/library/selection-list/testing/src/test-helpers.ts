 ...
 */
export const getAllSelectionListInstances = (fixture: ComponentFixture<any>): TsSelectionListComponent[] => getAllSelectionListDebugElements(fixture).map(v => v.componentInstance);
